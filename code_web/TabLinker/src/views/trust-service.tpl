...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="../img/Accurator.png">
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- <a class="navbar-brand" href="#"><img src="/img/Accurator.png"></a> -->
  ...
  <img src="/img/Accurator.png"> 
	...
	<h3>Quality Estimation of Annotations</h3> <a href="https://sealincmedia.wordpress.com/" target="_blank">https://sealincmedia.wordpress.com/</a>
	<hr>
	...
	<form action="/trust/upload" method="post" enctype="multipart/form-data">
          ...
          <input type="submit" name="submit" value="upload now" style="position:relative; top:25px;" />
	...
	%else:
	<form action="/trust/output" method="get">
	  <p>TabLinker generated {{numtriples}} triples successfully</p>
    <input type="submit" class="btn btn-primary" value="Generate trust values" />
